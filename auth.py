...
def createAccount(username, password):
    ...
    requests.get(' https://cwdcv6j468.execute-api.us-east-2.amazonaws.com/default/createAccount', params={'username': username, 'password': password})
    return False
...
def loginAccount(username, password):
    ...
    requests.get(' https://8f89bz3m0m.execute-api.us-east-2.amazonaws.com/default/loginAccount', params={'username': username, 'password': password})
    return False
...
def lookupAccount(username):
    ...
    requests.get(' https://amxm0kk9k8.execute-api.us-east-2.amazonaws.com/default/lookupAccount', params={'username': username})
